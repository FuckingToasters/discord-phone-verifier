...
------------------------------------
It request a second captcha solution if required, you may want to rather waste sms than submitting an second captcha solution if the price for capsolving is higher than for ordering an SMS.\
