...
class config:
    def loadconfig(self):
        ...
        return self.CAPTCHASERVICE, self.CAPTCHAPIKEY, self.CAPTCHASITEKEY, self.PHONESERVICE, self.RETRIES, self.VAKAPIKEY, self.VAKCOUNTRY, self.ONLINESIMAPIKEY, self.ONLINESIMCOUNTRY
